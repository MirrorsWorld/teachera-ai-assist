...
import { type Conversation, getConversation } from "@/api/conversation"
...
const Index = () => {
  ...
  const handleNewChat = async (newConv: Conversation, initialMsg?: string, initialImgurl?: string) => {
  ...
  return (
    <div className="h-screen flex flex-col font-roboto overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        {/* 左侧边栏 固定宽度，独立滚动*/}
        {isLoggedIn && (
          <div className="bg-slate-100 border-r border-gray-200 flex-shrink-0 flex flex-col">
            <Sidebar
              conversationsList={conversationListRef}
              onNewChat={handleNewChatBefore}
        ...
        >
          {viewMode === "welcome" ? (
            <MainContent onNewConversation={handleNewChat} />
          ) : (
        ...
        {isLoggedIn && showHtmlPanel && (
          <div className="w-[46%] bg-gray-50 transition-all duration-300 flex-shrink-0">
            <div className="h-full bg-white border-r border-l border-gray-200 flex flex-col">
