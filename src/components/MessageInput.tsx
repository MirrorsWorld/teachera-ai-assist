    ...
    <div className="w-full max-w-3xl mx-auto mb-10">
      <div className="relative">
        <textarea
          ...
          className="w-full p-5 rounded-xl border border-gray-200 font-roboto text-base transition-all duration-300 resize-none h-36 shadow-[0_4px_15px_rgba(0,0,0,0.05)] focus:outline-none focus:border-accent focus:shadow-[0_0_0_3px_rgba(67,97,238,0.2)]"
          placeholder="输入知识点或试题内容..."
        />
        <button
