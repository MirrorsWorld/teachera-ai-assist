...
const ActionButtons = ({ onUpload, onKnowledge, onMistakes }: ActionButtonsProps) => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      >
        <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mb-5 text-3xl text-primary">
          <Upload className="w-7 h-7" />
        </div>
        <h3 className="text-lg font-semibold mb-3 text-gray-900">上传试题生成</h3>
